...
import { BookOpen, Menu, X, MessageSquare, Zap, Search, ArrowRight, Library, ChevronDown } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="text-neutral-400 text-sm text-center md:text-right">
              <p>&copy; {new Date().getFullYear()} Developed By Khaleel Kattathar.</p>
